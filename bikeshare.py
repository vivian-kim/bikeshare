...
# get user input for day of week (all, monday, tuesday, ... sunday)
    ...
    while True:
        ...
        if city in Cities:
            ...
            print ('Please only select one of them: Newyork, Washington, Chicago').lower()
            city = raw_input()

    while True:
        month = raw_input('Please type a specific month or type all').lower()
        if month in Months:
            break
        else:
            print ('Please select a month, from January to December?').lower()
            month = raw_input()

    while True:
        day = raw_input('Please select a specific day, from Monday to Friday or all').lower()
        if day in Days:
            break
        else:
            print ('Please select a day, from Monday to Sunday').lower()
            day = raw_input()
